...
OUTPUT_DIR = SCRIPT_DIR / "results" / "verify_environment"
...
if __name__ == "__main__":
    ...
    plot_bhi_policy_only(
        ...
        bhi_threshold=bhi_threshold,
        output_file=OUTPUT_DIR / "bhi_policy_only.png"
    )
    ...
    plot_condition_states_for_each_element(
        ...
        output_folder=OUTPUT_DIR / "bhi_policy_condition_states"
    )
...
if __name__ == "__main__":
    ...
    plot_time_policy_only(
        ...
        every_year=every_year,
        output_file=OUTPUT_DIR / "time_policy_bhi_only.png"
    )

    plot_condition_states_for_each_element(
        df=df_time_policy,
        policy_label=f"Time-based replacement every {every_year} years",
        output_folder=OUTPUT_DIR / "time_policy_condition_states"
    )
#%%
